...
const module = defineNuxtModule({
  ...
  async setup(options, nuxt) {
    ...
    if (options.shiki) {
      addPlugin(resolver.resolve("./runtime/plugins/shiki"));
    }
    if (options.leaflet) {
    ...
    addComponentsDir({
      path: resolver.resolve("./runtime/components/html-block"),
      prefix: options.html?.prefix,
      pathPrefix: false
    });
    addComponentsDir({
      path: resolver.resolve("./runtime/components/html-inline"),
      prefix: options.html?.prefix,
      pathPrefix: false
    });
    addComponentsDir({
      path: resolver.resolve("./runtime/components/html-table"),
      prefix: options.html?.prefix,
      pathPrefix: false
    });
    addComponent({
      name: `${options.html?.prefix}-P`,
      filePath: resolver.resolve("./runtime/components/html-block/paragraph")
    });
    addComponent({
      name: `${options.html?.prefix}-H`,
      filePath: resolver.resolve("./runtime/components/html-inline/headings")
    });
    addComponent({
      name: `${options.html?.prefix}-A`,
      filePath: resolver.resolve("./runtime/components/html-inline/anchor")
    });
    addComponent({
      name: `${options.html?.prefix}Span`,
      filePath: resolver.resolve("./runtime/components/html-inline/inline")
    });
    addComponent({
      name: `${options.html?.prefix}Inline`,
      filePath: resolver.resolve("./runtime/components/html-inline/inline")
    });
    addComponent({
      name: `${options.html?.prefix}Img`,
      filePath: resolver.resolve("./runtime/components/html-block/image")
    });
    addComponent({
      name: `${options.html?.prefix}Dd`,
      filePath: resolver.resolve(
        "./runtime/components/html-block/definitionDescription"
      )
    });
    addComponent({
      name: `${options.html?.prefix}Dt`,
      filePath: resolver.resolve("./runtime/components/html-block/definitionTerm")
    });
    addComponent({
      name: `${options.html?.prefix}Dl`,
      filePath: resolver.resolve("./runtime/components/html-block/definitionList")
    });
    addComponent({
      name: `${options.html?.prefix}Ul`,
      filePath: resolver.resolve("./runtime/components/html-block/list")
    });
    addComponent({
      name: `${options.html?.prefix}Li`,
      filePath: resolver.resolve("./runtime/components/html-block/listItem")
    });
    addComponentsDir({
    ...
    addComponent({
      ...
      filePath: resolver.resolve(
        "./runtime/components/bootstrap/vertical-rule/verticalRule"
      )
    });
    addComponent({
    ...
    addComponent({
      name: `${options.bootstrap?.prefix}Anchor`,
      filePath: resolver.resolve("./runtime/components/html-inline/anchor")
    });
    addComponent({
    ...
    addComponentsDir({
      path: resolver.resolve("./runtime/components/mjml"),
      pathPrefix: false
    });
    addComponent({
      name: "SwiperSlide",
    ...
    addImportsDir(resolver.resolve("runtime/composables/extend/dynamicRoute"));
    if (options.vueuse) {
    ...
    if (options.integration) {
      ...
      addComponent({
        name: `${options.integration?.prefix}ArrayQuery`,
        filePath: resolver.resolve("./runtime/components/integration/arrayQuery")
      });
      addComponent({
        name: `${options.integration?.prefix}DataTable`,
        filePath: resolver.resolve("./runtime/components/integration/dataTable")
      });
      addComponent({
        name: `${options.integration?.prefix}FuzzySearch`,
        filePath: resolver.resolve("./runtime/components/integration/fuzzySearch")
      });
    }
    if (options.static) {
