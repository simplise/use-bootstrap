...
<template>
  ...
  <footer class="text-muted py-5">
    <div class="container">
      ...
      <p class="mb-0">
        جديد على Bootstrap؟ <a href="/"> تفضل بزيارة الصفحة الرئيسية </a> أو اقرأ <a href=""> دليل البدء </a>.
      </p>
      <!-- <p class="mb-0">جديد على Bootstrap؟ <a href="/"> تفضل بزيارة الصفحة الرئيسية </a> أو اقرأ <a href="{{< docsref "/getting-started/introduction"></div> "> دليل البدء </a>.</p> -->
    </div>
  </footer>
</template>
