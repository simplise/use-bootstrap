...
<template>
  ...
  >
    <b-div
      ...
      role="document"
    >
      <b-div class="modal-content rounded-4 shadow">
        <b-div class="modal-header border-bottom-0">
          <b-h
            level="5"
            class="modal-title"
          >
        ...
        <b-div class="modal-body py-0">
          <b-p>This is a modal sheet, a variation of the modal that docs itself to the bottom of the viewport like the newer share sheets in iOS.</b-p>
        </b-div>
        <b-div class="modal-footer flex-column border-top-0">
          <b-button
            type="button"
  ...
  >
    <b-div
      ...
      role="document"
    >
      <b-div class="modal-content rounded-3 shadow">
        <b-div class="modal-body p-4 text-center">
          <b-h
            level="5"
            class="mb-0"
          >
        ...
        <b-div class="modal-footer flex-nowrap p-0">
          <b-button
            type="button"
        ...
        <b-div class="modal-body p-5">
          ...
          <ul class="d-grid gap-4 my-5 list-unstyled">
            <li class="d-flex gap-4">
              <svg
                class="bi text-muted flex-shrink-0"
                width="48"
                height="48"
              >
  ...
  >
    ...
    >
      <b-div class="modal-content rounded-4 shadow">
        <b-div class="modal-header p-5 pb-4 border-bottom-0">
          <!-- <b-h level="5" class="modal-title">Modal title</b-h> -->
          <b-h
            level="2"
            class="fw-bold mb-0"
          >
        ...
        <b-div class="modal-body p-5 pt-0">
          <BForm class="">
