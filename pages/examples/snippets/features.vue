...
<template>
  ...
  <main>
    ...
    >
      ...
      <b-div class="row row-cols-1 row-cols-lg-3 align-items-stretch g-4 py-5">
        <b-div class="col">
          ...
          >
            <b-div class="d-flex flex-column h-100 p-5 pb-3 text-white text-shadow-1">
              <b-h
                level="2"
        ...
        <b-div class="col">
          ...
          >
            <b-div class="d-flex flex-column h-100 p-5 pb-3 text-shadow-1">
              <b-h
                level="2"
                class="pt-5 mt-5 mb-4 display-6 lh-1 fw-bold"
              >
    ...
    >
      ...
      <b-div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-4 g-4 py-5">
        <b-div class="col d-flex align-items-start">
          <svg
          ...
          <b-div>
            ...
            <b-p>Paragraph of text beneath the heading to explain the heading.</b-p>
          </b-div>
        </b-div>
        <b-div class="col d-flex align-items-start">
          <svg
