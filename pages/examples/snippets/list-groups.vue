...
<template>
  ...
  <p><br></p>
  <b-div class="list-group w-auto mt-5 mb-5">
    <b-a
      href="#"
    ...
    >
      ...
      >
      <b-div class="d-flex gap-2 w-100 justify-content-between">
        <b-div>
          <b-h
            level="6"
            class="mb-0"
  ...
  <b-div class="d-flex gap-5 justify-content-center">
    <b-div class="list-group mx-0 w-auto">
  ...
  <b-div class="list-group w-auto">
    <label class="list-group-item d-flex gap-3">
      ...
      >
      <b-span class="pt-1 form-checked-content">
  ...
  <b-div class="list-group list-group-checkable d-grid gap-2 border-0 w-auto">
    <input
    ...
    >
      First radio
      <b-span class="d-block small opacity-50">With support text underneath to add more detail</b-span>
    </label>
    ...
    >
      Second radio
      <b-span class="d-block small opacity-50">Some other text goes here</b-span>
    </label>
    ...
    >
      Third radio
      <b-span class="d-block small opacity-50">And we end with another snippet of text</b-span>
    </label>
    ...
    >
      ...
      <b-span class="d-block small opacity-50">This option is disabled</b-span>
    </label>
  </b-div>

  <b-div class="b-example-b-divider" />

  <b-div class="list-group list-group-radio d-grid gap-2 border-0 w-auto">
    <b-div class="position-relative">
      <input
      ...
      >
        ...
        <b-span class="d-block small opacity-75">With support text underneath to add more detail</b-span>
      </label>
    </b-div>
    ...
    <b-div class="position-relative">
      ...
      >
        ...
        <b-span class="d-block small opacity-75">Some other text goes here</b-span>
      </label>
    </b-div>
    ...
    <b-div class="position-relative">
      ...
      >
        ...
        <b-span class="d-block small opacity-75">And we end with another snippet of text</b-span>
      </label>
    </b-div>
    ...
    <b-div class="position-relative">
      ...
      >
        ...
        <b-span class="d-block small opacity-75">This option is disabled</b-span>
      </label>
    </b-div>
  </b-div>
</template>
