...
<template>
  ...
  <div class="container enter-block ">
  ...
  <header class="p-3 bg-dark text-white">
    <b-div class="container">
      <b-div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
        <b-a
          href="/"
  ...
  <header class="py-3 mb-3 border-bottom">
    ...
    >
      ...
      <b-div class="d-flex align-items-center">
        ...
        <b-div class="flex-shrink-0 dropdown">
          <b-a
            id="dropdownUser2"
            href="#"
            class="d-block link-dark text-decoration-none dropdown-toggle"
  ...
  <b-div class="container-fluid pb-3">
    <b-div
      class="d-grid gap-3"
      style="grid-template-columns: 1fr 2fr;"
    >
      <b-div class="bg-light border rounded-3">
  ...
  <nav class="py-2 bg-light border-bottom">
    <b-div class="container d-flex flex-wrap">
  ...
  <header class="py-3 mb-4 border-bottom">
    <b-div class="container d-flex flex-wrap justify-content-center">
      <b-a
        href="/"
  ...
  <header>
    <b-div class="px-3 py-2 bg-dark text-white">
      <b-div class="container">
        <b-div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
          <b-a
            href="/"
    ...
    <b-div class="px-3 py-2 border-bottom mb-3">
      <b-div class="container d-flex flex-wrap justify-content-center">
        <form
